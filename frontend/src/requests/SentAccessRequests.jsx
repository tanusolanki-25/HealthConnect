...
export default function SentAccessRequests() {
  ...
  const fetchRequests = async () => {
    ...
    try {
      ...
      toast.error(
        err.response?.data?.message || "Could not fetch access requests",
      );
    } finally {
      setLoading(false);
    }
  ...
  return (
    <div className="h-[calc(100vh-4rem)] overflow-hidden">
      <div className="flex flex-col md:flex-row gap-3 max-w-9xl mx-auto">
        ...
        <div className="flex-1 space-y-2 md:ml-64 h-full flex flex-col p-2">
          {/* Header */}
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white p-6 rounded shadow-sm border border-gray-100 ">
            <div>
              ...
              <p className="text-sm text-gray-500 mt-1">
                Track permissions requested from patients to view records &
                issue prescriptions
              </p>
            </div>
