import { Mail, Lock, ArrowRight, UserCheck, ShieldCheck, HeartPulse, CheckCircle2 } from "lucide-react";
...
export default function Login() {
  ...
  return (
   <div className="bg-slate-50/80 flex items-center justify-center p-2">
      ...
      {/* Card */}
          <div className="lg:col-span-6 p-6 sm:p-10 lg:p-10 lg:m-12 flex flex-col justify-center">
          ...
          <div>
            ...
            <p className="mt-2 text-sm text-gray-500">
             Log in to manage your health records securely </p>
          </div>
          ...
          <div className="mt-2">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-3 border border-gray-300 rounded-xl py-3 hover:bg-gray-50 active:bg-gray-100 transition-colors duration-200 text-sm font-medium text-gray-700"
            >
              <GoogleIcon />
