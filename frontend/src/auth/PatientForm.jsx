...
function PatientForm({ onDone }) {
  ...
  return (
   <div className="min-h-screen bg-[#f5f7ff] flex flex-col items-center justify-center px-4 mt-10 relative overflow-hidden">
      {/* Card */}
      <div className="relative z-10 bg-white rounded-2xl shadow-md w-full max-w-md p-4 mt-10 mb-4">
       ...
       <div>
          ...
          <div>
           ...
           <div>
            ...
            <div className="flex items-center rounded-lg border border-gray-300 py-3 focus-within:border-blue-600">
             <select {...register("gender")} className="ml-3 w-full outline-none">
